...
const Courses = () => {
  ...
  const allPossibleLevels = ['100L', '200L', '300L', '400L', '500L'];
  const levelIndex = allPossibleLevels.indexOf(user.level);

  const levels = [
    'All',
    ...(levelIndex !== -1
      ? allPossibleLevels.slice(0, levelIndex + 1)
      : allPossibleLevels),
  ];
              ...
              <motion.div
                ...
                <div className={styles.statCardContent}>
                  <div className={`${styles.iconContainer} ${styles.purpleBg}`}>
                    <LuClock
                      className={`${styles.icon} ${styles.purpleText}`}
                    />
                  </div>
                  <div>
                      ...
                      <div className={styles.courseContent}>
                        ...
                        <div className={styles.courseStats}>
                          <div className={styles.statsGroup}>
                            ...
                            {course.expectedSchedules} lessons
                          </div>
                          <div className={styles.statsGroup}>
