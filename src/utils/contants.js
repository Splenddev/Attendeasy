...
export const formDataAssets = [
  ...
  },
  {
    ...
    selectOptions: [
      ...
      {
        name: 'settings.deviceLock',
        title: 'Restrict by Device',
        type: 'select',
        options: [
          { text: 'Yes (1 mark per device)', value: true },
          { text: 'No (allow shared devices)', value: false },
        ],
        required: true,
      },
      {
        name: 'settings.ipRestriction',
        title: 'Restrict by IP Address',
        type: 'select',
        options: [
          { text: 'Yes (1 mark per IP)', value: true },
          { text: 'No (allow shared network)', value: false },
        ],
        required: true,
      },
      {
