  ...
  },
  {
    ...
    selectOptions: [
      ...
      },
      {
        ...
        type: 'select',
        options: [
          { text: 'Yes (joined after creation)', value: true },
          { text: 'No (lock to current students)', value: false },
        ],
        required: true,
      },
      {
        ...
        type: 'select',
        options: [
          { text: 'Yes (check-in + check-out)', value: true },
          { text: 'No (check-in only)', value: false },
        ],
        required: true,
      },
      {
        ...
        type: 'select',
        options: [
          { text: 'Yes (before marking window)', value: true },
          { text: 'No (block early check-in)', value: false },
        ],
        required: true,
      },
      {
        ...
        type: 'select',
        options: [
          { text: 'Yes (after window)', value: true },
          { text: 'No (block late check-in)', value: false },
        ],
        required: true,
      },
      {
        ...
        options: [
          ...
          { text: 'No (block early check-out)', value: false },
        ],
        required: true,
      },
      {
        ...
        options: [
          ...
          { text: 'No (block late check-out)', value: false },
        ],
        required: true,
      },
      {
      ...
      },
      {
        ...
        type: 'select',
        options: [
          { text: 'Yes (auto-repeat weekly)', value: true },
          { text: 'No (one-time)', value: false },
        ],
        required: true,
      },
      {
        ...
        type: 'select',
        options: [
          { text: 'Yes (send push/email)', value: true },
          { text: 'No (silent)', value: false },
        ],
        required: true,
      },
      {
